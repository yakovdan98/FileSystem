...
public class SysLib {
    ...
    {
        return Kernel.interrupt(1, 18, fd, null);
    }

    public static int open(String filename, String mode)
    {
        String[] s = {filename, mode};
        return Kernel.interrupt(1, 14, 0, s);
    }

    public static int read(int blockNumber, byte[] buffer)
    {
        return Kernel.interrupt(1, 8, blockNumber, buffer);
    }

    public static int write(int blockNumber, byte[] buffer)
    {
        return Kernel.interrupt(1, 9, blockNumber, buffer);
    }

    public static int seek(int fd, int offset, int whence)
    {
        int[] i = {offset, whence};
        return Kernel.interrupt(1, 17, fd, i);
    }
